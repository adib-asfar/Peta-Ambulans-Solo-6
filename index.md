...
<html>
  <head>
    <meta charset='utf-8' />
    <title>Peta Ambulans Soloraya</title>
    ...
    <style>
      ...
      * {
      ...
      .listings .item .title:hover { color:#f73e3e; }
  ...
  <body>
    ...
    $(document).ready(function () {
       ...
       * in the sidebar.
      */
      csvData.features.forEach(function(csvData, i){
        csvData.properties.id = i;
      });
      ...
      */
      map.on('load', function (e) {
        ...
        */
        buildLocationList(csvData);
        addMarkers();
      });

      /**
       * Add a marker to the map for every ambulance listing.
      **/
      function addMarkers() {
        /* For each feature in the GeoJSON object above: */
        csvData.features.forEach(function(marker) {
      ...
      **/
      function buildLocationList(data) {
        data.features.forEach(function(csvData, i){
          /**
           * Create a shortcut for `csvData.properties`,
           * which will be used several times below.
          **/
          var prop = csvData.properties;
      ...
      **/
      function flyTocsvData(currentFeature) {
        map.flyTo({
